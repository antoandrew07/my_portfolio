  ...
  return (
    <section id="intro">
        <div className="introContent">
            ...
            <span className="introText">I'm <span className='introName'>Andrews</span><br /><Typewriter options={{strings:["Web Developer","Front-end Developer"],autoStart:true,loop:true}}/></span>
